...
TOOLSETS = {
    ...
    "hermes-synology-chat": {
        "description": "Synology Chat bot toolset - full access for personal use (terminal has safety checks)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
